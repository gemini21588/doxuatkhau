...
Public Class LoginModel
    <Required(ErrorMessage:="Tên đăng nhập không được phép rỗng.")> _
    <Display(Name:="Tên đăng nhập")> _
    Public Property UserName As String

    <Required(ErrorMessage:="Mật khẩu không được phép rỗng.")> _
    <DataType(DataType.Password)> _
    <Display(Name:="Mật khẩu")> _
